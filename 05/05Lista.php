...
$letra = $letrallega."%";
$contar = "SELECT * FROM ma_certificados WHERE nomb_usu LIKE '$letra' AND veri_cer = '1';";
...
{
echo "<div class='t6'>";
echo "No se encontraron CERTIFICADOS VERIFICADOS Registrados";
echo "</div>";
} else {
echo "<div align='left' class='t6'>";
echo " ".$totales." CERTIFICADOS VERIFICADOS Registrados para Representantes que inician con la Letra ".$letrallega;
echo "</div>";
echo "<p>";
?>
...
$fecv_cer = $row["fecv_cer"];
$dptores = "54";
?>
<tr onMouseOver="this.className = 'resaltar1'" onMouseOut="this.className = 'resaltar2'" class="tabla_lista_text">
<td width="3%"><?php echo $codi_cer ; ?></td>
<td width="9%"><?php echo $ndoc_usu; ?></td>
<td width="18%"><?php echo htmlentities($nomb_usu); ?></td>
<td width="14%"><?php echo $fech_cer; ?></td>
<td width="14%"><?php echo $ipso_cer; ?></td>
<td width="13%"><?php echo $nume_cer; ?></td>
<td width="19%"><?php 
$codi_jun; 
...
echo htmlentities($junta)." de ".htmlentities($munici);
 ...
 ?></td>
<td width="10%"><?php echo $fecv_cer; ?></td>
</tr>
